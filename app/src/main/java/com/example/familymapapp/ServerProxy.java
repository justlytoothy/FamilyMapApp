...
public class ServerProxy {
    ...
    public static LoginResult login(String serverHost, String serverPort, LoginRequest request) {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                LoginResult loginResult = new LoginResult(http.getResponseMessage(),false);
    ...
    public static RegisterResult register(String serverHost, String serverPort, RegisterRequest request) {
        try {
            ...
            if (http.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                // occurred, so print out the message from the HTTP response
                System.out.println("ERROR: " + http.getResponseMessage());
                RegisterResult registerResult = new RegisterResult(http.getResponseMessage(),false);
    ...
    public static PersonResult getPerson(String serverHost, String serverPort, String authToken) {
        try {
    ...
    public static EventResult getEvents(String serverHost, String serverPort, String authToken) {
        try {
